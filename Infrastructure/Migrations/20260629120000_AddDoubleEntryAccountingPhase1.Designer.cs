...
namespace POSSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260629120000_AddDoubleEntryAccountingPhase1")]
    partial class AddDoubleEntryAccountingPhase1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POSSystem.Domain.ExceptionLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("POSSystem.Domain.GlAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("idx_accounts_branchid");

                    b.HasIndex("BusinessId")
                        .HasDatabaseName("idx_accounts_businessid");

                    b.HasIndex("ParentId")
                        .HasDatabaseName("idx_accounts_parentid");

                    b.HasIndex("BusinessId", "BranchId")
                        .HasDatabaseName("idx_accounts_business_branch");

                    b.HasIndex("BusinessId", "BranchId", "Name")
                        .HasDatabaseName("idx_accounts_business_branch_name");

                    b.ToTable("Accounts", (string)null);
                });

            modelBuilder.Entity("POSSystem.Domain.GlTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POSSystem.Domain.LowStockAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("idx_lowstockalerts_branchid");

                    b.HasIndex("BusinessId")
                        .HasDatabaseName("idx_lowstockalerts_businessid");
                    ...
                    b.HasIndex("BusinessId", "BranchId")
                        .HasDatabaseName("idx_lowstockalerts_business_branch");
            ...
            modelBuilder.Entity("POSSystem.Domain.Product", b =>
                {
                    ...
                    b.Property<decimal?>("LowStockAlertLevel")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("POSSystem.Domain.GlAccount", b =>
                {
                    ...
                    b.HasOne("POSSystem.Domain.GlAccount", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("POSSystem.Domain.GlTransaction", b =>
                {
                    b.HasOne("POSSystem.Domain.GlAccount", "Account")
                        .WithMany()
