...
public static class NavigationMenuSeeder
{
    ...
    [
        ...
        new("Menu", "/menu", "🍽️", "Menu", "Master Data", 4),
        new("Categories", "/categories", "🗂️", "Categories", "Master Data", 5),
        new("SubCategories", "/subcategories", "🧩", "SubCategories", "Master Data", 6),
        new("Products", "/products", "🧾", "Products", "Master Data", 7),
        new("Customers", "/customers", "🙋", null, "Master Data", 8),
        new("Suppliers", "/suppliers", "🚚", null, "Master Data", 9),
        new("Units", "/units", "⚖️", null, "Master Data", 10),
        new("Taxes", "/taxes", "💸", null, "Master Data", 11),
        new("Discounts", "/discounts", "🏷️", null, "Master Data", 12),
